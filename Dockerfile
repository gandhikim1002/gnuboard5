...
# upstream tarballs include ./wordpress/ so this gives us /usr/src/wordpress
	tar -xzf gnuboard5.tar.gz -C /usr/src/; \
	mv /usr/src/gnuboard5-$version /usr/src/gnuboard5; \
	rm gnuboard5.tar.gz; \
	mkdir /usr/src/gnuboard5/data; \
	\
# https://wordpress.org/support/article/htaccess/
	[ ! -e /usr/src/gnuboard5/.htaccess ]; \
	{ \
		echo '# BEGIN gnuboard5'; \
		echo ''; \
	...
	\
	chown -R www-data:www-data /usr/src/gnuboard5; \
	chmod -R 777 /usr/src/gnuboard5
